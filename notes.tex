...
\begin{exercise}
    Check that path objects in a type theoretic weak factorization system satisfy the hypotheses of \Cref{lem:equivalence relation}.
\end{exercise}
...
\end{lemma}
\begin{proof}
    To show that an object $X$ is fibrant, we need to show that $!: X \to *$ is in the right class. By  \Cref{lem:generate-wfs}, we need to check that there is a lift in square (**).
    \[
        \begin{tikzcd}
